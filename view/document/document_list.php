...
<div class="row mb-2 p-2 m-0 border border-2">
    <div class="col-md-3">
        <h4 class="fs-1">Document List</h4>
    </div>
...
<div class="viewData table-responsive">
    <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
            <?php $brch = mysqli_query($con, "SELECT * FROM document_list");
            $cnt = 1;
                    ...
                    <div class="col-md-6 form-group">
                        <label class="form-label">Types</label>
                         <select name="document_types" class="form-control">
                          <?php
                          $doctype=mysqli_query($con,"SELECT  * FROM document_typeslist");
                           foreach ($doctype as $doc)
                           {
                            echo '<option value="'.$doc['doc_id'].'">'.$doc['doc_Title'].'</option>';
                           }
                          ?>
                         </select>
                    </div>
