...
<div class="row mb-2 p-2 m-0 border border-2">
    <div class="col-md-3">
        <h4 class="fs-1">Notice Document List</h4>
    </div>
...
<div class="viewData table-responsive">
    <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
            <?php $brch = mysqli_query($con, "SELECT * FROM `document_list` INNER JOIN document_typeslist ON document_list.document_types=document_typeslist.doc_id WHERE document_typeslist.doc_Title='Notice'");
            $cnt = 1;
