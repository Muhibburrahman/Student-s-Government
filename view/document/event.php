...
<div class="viewData table-responsive">
    <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
            <?php $brch = mysqli_query($con, "SELECT * FROM `document_list` INNER JOIN document_typeslist ON document_list.document_types=document_typeslist.doc_id WHERE document_typeslist.doc_Title='Event'");
            $cnt = 1;
